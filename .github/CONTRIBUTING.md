...
Love `fuel-core` and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/fuel-labs/fuel-core/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/fuel-core.git
   # Navigate to the newly cloned directory
   cd fuel-core
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/fuel-core/fuel-core.git
   ```
...
**DESIGN NOTE**: fuel-core follows the UNIX programming philosophy. Please consider this before contributing, keep your commits/modules concise and to the point.
